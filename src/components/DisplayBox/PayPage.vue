  ...
  <div class="glass-pay-container">
    <div class="glass-card">
      ...
      <div class="order-details">
        ...
        <div class="detail-item">
          <span class="detail-label">购买类型：</span>
          <span class="detail-value">{{ item.ticketType }}</span>
        </div>
        <div class="detail-item highlight">
          <span class="detail-label">订单价格：</span>
        ...
        <div class="payment-methods">
          ...
          <div class="PayPage_center">
            <div class="payment-option">
              ...
              <div style="display: flex; flex-wrap: nowrap;">
                <svg t="1739023282990" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
                  p-id="7093" width="45" height="45">
                  <path
          ...
          <div class="PayPage_center">
            <div class="payment-option">
              ...
              <div style="display: flex; flex-wrap: nowrap;">
                <svg t="1739028308319" class="icon" viewBox="0 0 1024 1024" version="1.1"
                  xmlns="http://www.w3.org/2000/svg" p-id="10563" width="45" height="45">
                  <path
      ...
      <button @click="confirmPayment" class="pay-button">
        确认支付 {{ item.price }}元
      </button>
    </div>
    <!-- 使用组件 -->
    <PaymentSuccessModal :selectedPaymentMethod="selectedPaymentMethod" :isPaymentModalVisible="isPaymentModalVisible"
  ...
  if (route.query.item) {
    try {
      ...
      if (parsedItem.list && typeof parsedItem.list === 'object') {
        const ticketType = ['成人票', '儿童票', '家庭套票', 'VIP票'][parsedItem.selectedTicketIndex || 0];
        item.value = {
          ...parsedItem.list,
          price: parsedItem.price || parsedItem.list.price || 0,
          quantity: parsedItem.quantity || parsedItem.list.quantity || 1, // 重置quantity为默认值
          selectedTicketIndex: parsedItem.selectedTicketIndex || 0,
