<template>
  <section class="Confirm" @mousemove="onMouseMove" @mouseleave="onMouseLeave">
    <div class="Confirm-Header">
      <button class="Confirm-Header-Button Confirm-Header-Button_Close"
        @click.stop="$emit('closeDeleteModal')"></button>
      ...
      <h1 class="Confirm-Header-Title">删除提示框</h1>
    </div>

    <div class="Confirm-Body">
      <h2 class="Confirm-Body-Title">是否确实要删除？</h2>
      ...
      <button class="Confirm-Body-Button Confirm-Body-Button_Cancel" @click.stop="$emit('closeDeleteModal')">取消</button>
      <button class="Confirm-Body-Button Confirm-Body-Button_Delete" @click.stop="$emit('confirmDelete')">删除</button>
    </div>
  </section>
</template>
