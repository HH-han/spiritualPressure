<template>
  <div class="container-BH">
    ...
    <!-- 自定义详情弹出框 -->
    <div v-if="dialogVisible" class="custom-dialog-overlay" @click="closeDialog">
          ...
          <div v-if="selectedCard" class="detail-content-BH">
            ...
            <div class="detail-info-BH">
              ...
              <p>
                ...
                地址：{{ selectedCard.hotel_address || '暂无地址信息' }}
              </p>
              <p>
...
const fetchCards = async () => {
  try {
    ...
    // 为 hotel_name 设置默认值
    cards.value = res.data.list.map(card => ({
      ...card,
