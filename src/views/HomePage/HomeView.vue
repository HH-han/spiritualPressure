  ...
  <div>
    ...
    <div class="banner" @mouseover="stopAutoPlay" @mouseleave="startAutoPlay">
      ...
      <div class="homeview-hero-content">
        <h1 class="homeview-hero-title">探索世界的奇迹</h1>
        <p class="homeview-hero-subtitle">发现地球上最令人惊叹的地方，创造终生难忘的回忆</p>
    ...
    <main class="backgroundgradient">
      ...
      <!-- 推荐按钮 -->
      <div class="navscenic">
        <div class="navscenic_button">
          <button>热门景点</button>
          <button>最新发表</button>
        </div>
        <button @click="isshowComponent = true" class="navscenic_button-other">
          <span>更多</span>
        </button>
        <!-- 更多 -->
        <MoreRecommend v-if="isshowComponent" @close="NoMore" />
        <button @click="showNote = true" class="navscenic_button-other">
          <span>写游记</span>
        </button>
        <!-- 笔记 -->
      ...
      <div class="content_5">
        ...
        <div class="recommend-left">
          <div class="recommend-left_button">
            <router-link to="/SafetyTips">
              <button>旅游知识安全提示➡️</button>
            </router-link>
          </div>
        ...
        <div class="blog-post-container">
          ...
          <div class="block">
            <div class="paging-container">
              <div class="paging-info">共 <span class="paging-total">{{ total }}</span> 条</div>
...
// 详情模态框相关
const isDetailVisible = ref(false) // 控制模态框显示
const selectedBlog = ref(null) // 当前选中的博客
