<template>
  <div class="searchview">
    ...
    <div class="section-banner-Earth">
      <div id="star-1-Earth">
        <div class="curved-corner-star">
          <div id="curved-corner-bottomright-Earth"></div>
          <div id="curved-corner-bottomleft-Earth"></div>
        </div>
        <div class="curved-corner-star-Earth">
          <div id="curved-corner-topright-Earth"></div>
          <div id="curved-corner-topleft-Earth"></div>
        </div>
      </div>
...
.curved-corner-star-Earth {
  display: flex;
  position: relative;
}

#curved-corner-bottomleft-Earth,
#curved-corner-bottomright-Earth,
#curved-corner-topleft-Earth,
#curved-corner-topright-Earth {
  width: 4px;
  height: 5px;
  overflow: hidden;
  position: relative;
...
#curved-corner-bottomleft-Earth:before,
#curved-corner-bottomright-Earth:before,
#curved-corner-topleft-Earth:before,
#curved-corner-topright-Earth:before {
  content: "";
  display: block;
  width: 200%;
  height: 200%;
